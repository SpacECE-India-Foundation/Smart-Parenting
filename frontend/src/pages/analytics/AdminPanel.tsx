...
import { getChildren, getThresholds, saveThresholds, getAssessments, addAssessment, getAiAnalysis, getRecommendations, getReports, generateWeeklyReport, initializeDatabase } from '../../services/analyticsService';
    ...
    <div className="fade-in" style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
      ...
      <div className="dashboard-grid-2">
        <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
          ...
          <div className="glass-card">
            <h3>Trigger Weekly Report Task</h3>
            <p style={{ fontSize: '0.75rem', color: 'var(--text-secondary)', margin: '4px 0 16px 0' }}>Simulate the Scheduled background task, compiling reports and posting recommendations.</p>
