...
export const NAV_MENUS = {
  ...
  [ROLES.PARENT]: [
    ...
    { label: 'Child Portal', path: ROUTES.LOGIN_CHILD,         icon: 'SwapHoriz' },
    ...
    { label: 'Messages',     path: '/parent/messages',         icon: 'Chat'      },
  ...
  [ROLES.ADMIN]: [
    ...
    { label: 'Assign Students', path: '/admin/assignments',     icon: 'ChildCare'     },
