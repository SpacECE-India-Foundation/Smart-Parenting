...
export const storiesData = [
  {
    id: "story_1", title: "The Brave Lion", emoji: "🦁", author: "SpacECE Team",
    age_group: "4-6", difficulty: "Easy", language: "English", topic: "Courage",
    estimated_time: "5 min", is_featured: true,
  ...
  {
    id: "story_2", title: "Magic Forest", emoji: "🌿", author: "SpacECE Team",
    age_group: "7-10", difficulty: "Medium", language: "English", topic: "Nature",
    estimated_time: "8 min", is_featured: true,
  ...
  {
    id: "story_3", title: "Starry Night", emoji: "🌙", author: "SpacECE Team",
    age_group: "1-3", difficulty: "Beginner", language: "English", topic: "Bedtime",
    estimated_time: "3 min", is_featured: true,
  ...
  {
    id: "story_4", title: "Neel the Fish", emoji: "🐟", author: "SpacECE Team",
    age_group: "4-6", difficulty: "Easy", language: "English", topic: "Adventure",
    estimated_time: "6 min", is_featured: false,
  ...
  {
    id: "story_5", title: "Priya's Garden", emoji: "🌸", author: "SpacECE Team",
    age_group: "7-10", difficulty: "Hard", language: "हिंदी", topic: "Nature",
    estimated_time: "10 min", is_featured: false,
  ...
  {
    id: "story_6", title: "The Kind Elephant", emoji: "🐘", author: "SpacECE Team",
    age_group: "1-3", difficulty: "Beginner", language: "English", topic: "Kindness",
    estimated_time: "3 min", is_featured: false,
...
export const vocabData = [
  { id: 1, emoji: "🐘", word: "Elephant", meaning: "A large grey animal with a long trunk", image_url: "", age_group: "4-6" },
  { id: 2, emoji: "🌺", word: "Flower",   meaning: "A colourful bloom on a plant",         image_url: "", age_group: "4-6" },
  { id: 3, emoji: "🍎", word: "Apple",    meaning: "A round red or green fruit",            image_url: "", age_group: "1-3" },
  { id: 4, emoji: "🌊", word: "Wave",     meaning: "Water moving up and down",              image_url: "", age_group: "7-10" },
  { id: 5, emoji: "🦋", word: "Butterfly",meaning: "A colourful flying insect",             image_url: "", age_group: "4-6" },
  { id: 6, emoji: "⛰️", word: "Mountain", meaning: "A very tall hill of land",              image_url: "", age_group: "7-10" },
  { id: 7, emoji: "🌙", word: "Moon",     meaning: "Earth's natural satellite",             image_url: "", age_group: "1-3" },
  { id: 8, emoji: "🎨", word: "Colour",   meaning: "What we see in light — red, blue...",   image_url: "", age_group: "4-6" },
  { id: 9, emoji: "🐸", word: "Frog",     meaning: "A green animal that jumps and croaks",  image_url: "", age_group: "1-3" },
  { id:10, emoji: "🏠", word: "House",    meaning: "A building where people live",          image_url: "", age_group: "1-3" },
];

export const wordBuilderList = [
  { emoji: "🐸",  word: "FROG",     hint: "It jumps and says ribbit 🐸" },
  { emoji: "🌸",  word: "FLOWER",   hint: "Pretty and found in gardens 🌸" },
  { emoji: "🦁",  word: "LION",     hint: "King of the jungle 🦁" },
  { emoji: "🍎",  word: "APPLE",    hint: "A red juicy fruit 🍎" },
  { emoji: "🐟",  word: "FISH",     hint: "Lives in water 🐟" },
  { emoji: "🌙",  word: "MOON",     hint: "Shines at night 🌙" },
  { emoji: "🐘",  word: "ELEPHANT", hint: "Has a long trunk 🐘" },
  { emoji: "🏠",  word: "HOUSE",    hint: "Where we live 🏠" },
];

// Each animal has a Web Speech text that gets spoken aloud
export const soundMatchData = [
  { id:"s1", prompt: "Who says  Moo ?",    spokenPrompt:"Who says Moo?",    animals: ["🐮","🐷","🐔","🐸"], labels: ["Cow","Pig","Hen","Frog"], answer: 0, sound:"Moo Moo Moo" },
  { id:"s2", prompt: "Who says  Woof ?",   spokenPrompt:"Who says Woof?",   animals: ["🐱","🐶","🐦","🐸"], labels: ["Cat","Dog","Bird","Frog"], answer: 1, sound:"Woof Woof Woof" },
  { id:"s3", prompt: "Who says  Meow ?",   spokenPrompt:"Who says Meow?",   animals: ["🐶","🦁","🐱","🐮"], labels: ["Dog","Lion","Cat","Cow"],  answer: 2, sound:"Meow Meow" },
  { id:"s4", prompt: "Who says  Cluck ?",  spokenPrompt:"Who says Cluck?",  animals: ["🦅","🐔","🐟","🐷"], labels: ["Eagle","Hen","Fish","Pig"], answer: 1, sound:"Cluck Cluck Cluck" },
  { id:"s5", prompt: "Who says  Roar ?",   spokenPrompt:"Who says Roar?",   animals: ["🐮","🦊","🦁","🐸"], labels: ["Cow","Fox","Lion","Frog"],  answer: 2, sound:"Roarrr" },
  { id:"s6", prompt: "Who says  Ribbit ?", spokenPrompt:"Who says Ribbit?", animals: ["🐸","🐟","🐛","🐢"], labels: ["Frog","Fish","Worm","Turtle"],answer:0, sound:"Ribbit Ribbit" },
];

export const objectRecognitionData = [
  { id:"o1", word:"Apple",    items:["🍎","🐶","🚗","🏠"], answer:0 },
  { id:"o2", word:"Dog",      items:["🌸","🐶","⭐","🍎"], answer:1 },
  { id:"o3", word:"Star",     items:["🐘","🌊","⭐","🏠"], answer:2 },
  { id:"o4", word:"House",    items:["🐟","🌺","🎈","🏠"], answer:3 },
  { id:"o5", word:"Fish",     items:["🐟","🌸","🎨","🐘"], answer:0 },
  { id:"o6", word:"Elephant", items:["🐸","🏠","🐘","⭐"], answer:2 },
];

export const fluencyPassages = [
  {
    id:"f1", title:"The River", level:"Easy",
  ...
  {
    id:"f2", title:"The Market", level:"Medium",
  ...
  {
    id:"f3", title:"Technology Today", level:"Hard",
...
export const challengesData = [
  { id:1, icon:"🔤", title:"Alphabet Adventure", type:"alphabet",   desc:"Trace animated letters and match uppercase to lowercase!",  age:"4–6",  locked:false, color:"#F5A623" },
  { id:2, icon:"🔊", title:"Sound Matching",     type:"sound",      desc:"Match animal sounds to the right animals. Listen carefully!", age:"1–3",  locked:false, color:"#2EC4B6" },
  { id:3, icon:"👆", title:"Object Recognition", type:"object",     desc:"Tap the correct object when you hear its name.",              age:"1–3",  locked:false, color:"#7C4DFF" },
  { id:4, icon:"⏱️", title:"Reading Fluency",    type:"fluency",    desc:"Read a passage in 60 seconds. How many words can you read?",  age:"7–10", locked:false, color:"#FF6B9D" },
  { id:5, icon:"❓", title:"Story Comprehension", type:"comprehension",desc:"Answer questions about stories you've read.",               age:"7–10", locked:false, color:"#66BB6A" },
  { id:6, icon:"🅰️", title:"Phonics Mode",        type:"phonics",   desc:"Syllables highlighted as words are spoken. Great for phonics!",age:"4–6",  locked:false, color:"#FF8A65" },
];
